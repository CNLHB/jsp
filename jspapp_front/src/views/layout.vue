<template>
  <div class="layout">
    <Layout>
      ...
      >
        <div class="layout-logo-left" :style="isCollapsed ? 'font-size:12px': ''">学生管理</div>
        <Menu
          :accordion="true"
          width="auto"
      ...
      <Layout>
            ...
            <div style="float: right;margin-right: 20px" v-if="adminAuth">
              <Dropdown transfer trigger="click" @on-click="exitAccount">
                <a href="javascript:void(0)">
                  ...
                  >{{ adminAuth.username? adminAuth.username: adminAuth.account}}</span>
        ...
        <Content class="content-wrapper">
          ...
          <div class="layout-copy">{{new Date().getFullYear()}} &copy; 学生管理</div>
        </Content>
      </Layout>
    </Layout>
